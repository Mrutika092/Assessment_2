...
class HOTEL_MANAGEMENT:
    def __init__(self):
        ...
        self.Button2.place(relx=0.18, rely=0.17, height=50, width=566)
        ...
        self.Button9.place(relx=0.18, rely=0.25, height=50, width=566)
        ...
        self.Button9.configure(text='''REGISTER''')
        self.Button9.configure(width=566)
        self.Button9.configure(command=click_register)
