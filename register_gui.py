...
class HOTEL_MANGMENT_checkin:
    ...
    def __init__(self):
        ...
        def submit_clicked(n, e, mo, c, m):
            ...
            # sql_c = "INSERT INTO customers (name, email, number, city, gender) VALUES (%s, %s, %s, %s, %s)"
            # val_c = (n, e, mo, c, m)
            # c1.execute(sql_c, val_c)

            final_win = Tk()
            Label(final_win, text='CREATED!!').grid(row=0, column=0)
            print(n, e, mo, c, m)
            final_win.mainloop()
        ...
        font11 = "-family {Segoe UI} -size 25 -weight bold -slant "  \
            "roman -underline 0 -overstrike 0"
        font12 = "-family {Segoe UI} -size 18 -weight bold -slant "  \
            "roman -underline 0 -overstrike 0"
        font13 = "-family {Segoe UI} -size 20 -weight bold -slant "  \
            "roman -underline 0 -overstrike 0"
        ...
        self.Message1.configure(text='''Registration''')
        self.Message1.configure(width=496)

        self.Message2 = Message(self.Frame1)
        self.Message2.place(relx=0.50, rely=0.19, relheight=0.74, relwidth=0.07)
        ...
        self.Message3.place(relx=0.60, rely=0.15, relheight=0.84, relwidth=0.35)
        ...
        self.Message3.configure(text='''Please Enter Details*''')
        ...
        self.Label3.place(relx=0.05, rely=0.03, height=25, width=289)
        ...
        self.Label4.place(relx=0.045, rely=0.35, height=25, width=329)
        ...
        self.Entry5.configure(textvariable=self.email)

        self.Label5 = Label(self.Frame2)
        self.Label5.place(relx=0.045, rely=0.16, height=25, width=334)
        ...
        self.Label6.place(relx=0.045, rely=0.5, height=50, width=250)
        ...
        self.Checkbutton1 = Radiobutton(self.Frame2)
        self.gen1 = IntVar()
        self.Checkbutton1.place(relx=0.30, rely=0.5, relheight=0.17
                , relwidth=0.14)
        ...
        self.Checkbutton1.configure(variable=self.gen1)
        ...
        self.Checkbutton3 = Radiobutton (self.Frame2)
        self.gen2 = IntVar()
        self.Checkbutton3.place(relx=0.50, rely=0.5, relheight=0.17
                , relwidth=0.14)
        ...
        self.Checkbutton3.configure(text='''Female''')
        self.Checkbutton3.configure(variable=self.gen2)
        ...
        self.Entry1.configure(insertbackground="black")
        self.Entry1.configure(width=424)
        self.Entry1.configure(textvariable=self.city)
        ...
        self.Button4.place(relx=0.56, rely=0.66, height=83, width=156)
        ...
        self.Button4.configure(command=submit_clicked(self.name, self.email, self.mobile, self.city, self.gen1))
